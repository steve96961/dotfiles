...
```
sudo pacman -Suy hyprland fish wofi grim slurp nemo hyprpaper waybar alacritty noto-fonts noto-fonts-cjk noto-fonts-emoji noto-fonts-extra ttf-jetbrains-mono-nerd ttf-firacode-nerd
